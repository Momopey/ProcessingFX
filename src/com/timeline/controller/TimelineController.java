...
public class TimelineController{
    ...
    public TimelineController(Timeline dParent, Mode dMode){
...
//        System.out.println("Loading frame, modifying details");
    ...
    public boolean beforeController(TimelineController controller){
    ...
    public ArrayList<TimelineController> getControllersBefore(){
        ArrayList<TimelineController> controllersBefore= new ArrayList<>();
